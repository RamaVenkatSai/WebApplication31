...
namespace WebApplication31.Models
{
    ...
    public partial class OnlineExam1Entities : DbContext
    {
        ...
        public virtual ObjectResult<adminreport1_Result> adminreport1(string state, string city, string course, Nullable<int> marks)
        {
        ...
        public virtual ObjectResult<adminreport5_Result> adminreport5(string state, string city, string course, Nullable<int> marks)
        {
            var stateParameter = state != null ?
                new ObjectParameter("State", state) :
                new ObjectParameter("State", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<adminreport5_Result>("adminreport5", stateParameter, cityParameter, courseParameter, marksParameter);
        }
    }
}
